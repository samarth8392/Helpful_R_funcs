mutation_colors <- c("Nonsense mutation"="#ad7aff","Missense mutation"="#377EB8","Frameshift deletion"="#4DAF4A",
                     "In Frame Ins"="#ff008c","Splice Site"="#FF7F00","Multi Hit"="#FFFF33","Frameshift insertion"="#A65628",
                     "In Frame Del"="#f781bf","Translation Start site"="#400085","Nonstop Mutation"="#b68dfc",
                     "Amplification"="red","Deletion"="blue",
                     "Splice Region"="red","Silent"="blue",
                     "Germline Missense Mutation"="#377EB8",
                     "Germline Frame Shift Del"="#4DAF4A", "Germline Frameshift Del"="#4DAF4A","Germline Frameshift deletion"="#4DAF4A", 
